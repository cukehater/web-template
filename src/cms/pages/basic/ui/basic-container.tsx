...
function CardCompany({ form }: { form: UseFormReturn<BasicFormSchemaType> }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>
...
function CardNaver({ form }: { form: UseFormReturn<BasicFormSchemaType> }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>
...
function CardOpenGraph({ form }: { form: UseFormReturn<BasicFormSchemaType> }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>
...
function CardSEO({ form }: { form: UseFormReturn<BasicFormSchemaType> }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>
